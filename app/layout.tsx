  ...
  return (
    <html lang="en">
      <body className="bg-background text-foreground">
        ...
        <a
          href="#"
          className="fixed bottom-6 right-6 z-50 bg-primary hover:bg-gold text-white rounded-full shadow-lg p-4 flex items-center justify-center transition-all duration-200 group"
